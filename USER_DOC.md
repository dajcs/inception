...
We can try in the browser to go to `https://localhost:8443`, and it should work the same.

or the professional way, we can use `curl`:

```bash
curl -v -k --resolve anemet.42.fr:8443:127.0.0.1 https://anemet.42.fr:8443
